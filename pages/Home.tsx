      ...
      <div className="max-w-7xl mx-auto px-8 lg:px-20 py-16 lg:py-24 relative z-10">
          ...
          <div className="flex-1 text-left space-y-8">
            <div className="space-y-2">
              <h1 className="text-5xl lg:text-7xl font-black leading-none tracking-tighter uppercase">
                ESHULI<br />
                <span className="text-[#A3E635]">{t.technology}</span><br />
                LTD
              </h1>
            </div>
            ...
            <div className="flex gap-2">
              {[1, 2, 3, 4, 5].map((i) => (
                <div key={i} className="w-10 h-10 bg-[#A3E635] rounded-md shadow-lg shadow-[#A3E635]/10"></div>
              ))}
            </div>

            <div className="space-y-4">
              <p className="text-3xl lg:text-4xl font-black tracking-tight leading-tight">
                {t.inspire}<br />
                {t.transform}<br />
                <span className="text-[#A3E635]">{t.technology}</span>
              </p>
            </div>
          ...
          <div className="flex-1 relative w-full max-w-xl">
            <div className="relative rounded-[50px] overflow-hidden border border-white/5 group shadow-2xl">
               <img 
                 ...
                 alt="Electronics Lab" 
                 className="w-full aspect-[4/5] object-cover grayscale opacity-80 group-hover:grayscale-0 group-hover:scale-110 transition-all duration-1000"
               />
               ...
               <div className="absolute top-8 right-8 w-32 h-32 bg-[#A3E635] rounded-full shadow-2xl flex flex-col items-center justify-center p-4 text-center rotate-12 group-hover:rotate-0 transition-all duration-700">
                 ...
                 <div className="bg-red-600 w-10 h-8 rounded-lg flex items-center justify-center shadow-lg mb-2">
        ...
        <section ref={demosRef} id="demos" className="mt-20 scroll-mt-24">
          <div className="flex justify-between items-end mb-10">
            <div>
              <h2 className="text-2xl font-black uppercase tracking-tighter">{t.lesson_demos}</h2>
              <p className="text-[9px] text-gray-500 font-bold uppercase tracking-[0.2em] mt-2">Latest from Eshuli TV</p>
            </div>
            <a 
              href="https://www.youtube.com/@eshulitv4016" 
              target="_blank" 
              rel="noopener noreferrer"
              className="flex items-center gap-2 bg-[#A3E635]/10 border border-[#A3E635]/20 px-4 py-2 rounded-full text-[9px] font-black text-[#A3E635] hover:bg-[#A3E635] hover:text-black transition-all"
            >
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            {demos.map((demo, idx) => (
              <a 
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="group relative bg-[#0a0a0a] border border-white/5 rounded-[35px] overflow-hidden shadow-2xl hover:border-[#A3E635]/30 transition-all duration-500"
              >
                <div className="aspect-video relative overflow-hidden">
                  ...
                  <div className="absolute inset-0 flex items-center justify-center">
                    <div className="w-12 h-12 bg-white/10 backdrop-blur-md rounded-full flex items-center justify-center group-hover:scale-125 group-hover:bg-[#A3E635] transition-all duration-500">
                  ...
                  <div className="absolute top-4 left-4">
                    <span className="text-[7px] font-black uppercase tracking-[0.2em] bg-black/60 backdrop-blur-md px-3 py-1.5 rounded-full border border-white/10">
                      {demo.category}
                    </span>
                  </div>
                </div>
                <div className="p-6">
                  <h3 className="text-lg font-black uppercase tracking-tight group-hover:text-[#A3E635] transition-colors">{demo.title}</h3>
                  <p className="text-[9px] text-gray-500 font-bold uppercase tracking-widest mt-1">Eshuli TV Channel</p>
                </div>
              </a>
            ))}
          </div>
